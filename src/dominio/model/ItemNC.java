...
import dominio.model.uncompressed.FilePpm;
import dominio.model.uncompressed.FileTxt;
import dominio.model.uncompressed.Folder;
import java.io.File;
...
public abstract class ItemNC {
   ...
   * @return items
   */
  public abstract List<dominio.model.uncompressed.File> getItems();
